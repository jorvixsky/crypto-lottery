...
export interface SubscriptionAPI$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "SubscriptionAPI",
  "sourceName": "contracts/VRFCoordinatorMock/SubscriptionAPI.sol",
  "abi": [
    {
      "inputs": [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<SubscriptionAPI$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/VRFCoordinatorMock/SubscriptionAPI.sol:SubscriptionAPI",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<SubscriptionAPI$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<SubscriptionAPI$Type["abi"]>;
