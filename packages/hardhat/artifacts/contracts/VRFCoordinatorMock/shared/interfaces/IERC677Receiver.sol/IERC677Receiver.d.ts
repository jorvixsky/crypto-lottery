...
export interface IERC677Receiver$Type {
  ...
  "sourceName": "contracts/VRFCoordinatorMock/shared/interfaces/IERC677Receiver.sol",
  "abi": [
    {
      "inputs": [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "contracts/VRFCoordinatorMock/shared/interfaces/IERC677Receiver.sol:IERC677Receiver",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IERC677Receiver$Type["abi"]>>;
